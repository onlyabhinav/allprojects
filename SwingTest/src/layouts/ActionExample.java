    ...
    implements ActionListener, Accessible
{
        ...
        extends AccessibleContext
    {
        ...
        {
            return SwingUtilities.getAccessibleIndexInParent( ActionExample.this );
        }

        public int getAccessibleChildrenCount()
        {
            return SwingUtilities.getAccessibleChildrenCount( ActionExample.this );
        }
        ...
        implements AccessibleAction
    {
        ...
        public boolean doAccessibleAction( int i )
        {
            if ( i == 0 )
            {
                ...
                ActionExample.this.processActionEvent( new ActionEvent( this, ActionEvent.ACTION_PERFORMED,
