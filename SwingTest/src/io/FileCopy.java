...
/**
 * This class is a standalone program to copy a file, and also defines a static copy() method that other programs can
 * use to copy files.
 **/
public class FileCopy
{
        ...
        throws IOException
    {
        ...
        try
        {
            ...
            System.out.println( "File length: " + from_file.length() );
            ...
            {
                System.err.println( "Copied " + ( temp_data += bytes_read ) + " of " + from_file.length() );
