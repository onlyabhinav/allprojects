...
/**
 * Demo class which writes a spreadsheet. This demo illustrates most of the features of the JExcelAPI, such as text,
 * numbers, fonts, number formats and date formats
 */
public class Write
{
    /**
        ...
        throws WriteException
    {
        ...
        NumberFormat poundCurrency =
            new NumberFormat( NumberFormat.CURRENCY_POUND + " #,###.00", NumberFormat.COMPLEX_FORMAT );
        ...
        NumberFormat euroPrefixCurrency =
            new NumberFormat( NumberFormat.CURRENCY_EURO_PREFIX + " #,###.00", NumberFormat.COMPLEX_FORMAT );
        ...
        NumberFormat euroSuffixCurrency =
            new NumberFormat( "#,###.00" + NumberFormat.CURRENCY_EURO_SUFFIX, NumberFormat.COMPLEX_FORMAT );
        ...
        NumberFormat dollarCurrency =
            new NumberFormat( NumberFormat.CURRENCY_DOLLAR + " #,###.00", NumberFormat.COMPLEX_FORMAT );
        ...
        NumberFormat japaneseYenCurrency =
            new NumberFormat( NumberFormat.CURRENCY_JAPANESE_YEN + " #,###.00", NumberFormat.COMPLEX_FORMAT );
        ...
        NumberFormat fraction3digit1 =
            new NumberFormat( NumberFormat.FRACTION_THREE_DIGITS, NumberFormat.COMPLEX_FORMAT );
    ...
    /**
     * Adds cells to the specified sheet which test the various label formatting styles, such as different fonts,
     * different sizes and bold, underline etc.
     * 
     * @param s1
     */
        ...
        throws WriteException
    {
        ...
        WritableFont arial10ptUnderline =
            new WritableFont( WritableFont.ARIAL, WritableFont.DEFAULT_POINT_SIZE, WritableFont.NO_BOLD, false,
        ...
        WritableFont arial10ptDoubleUnderline =
            new WritableFont( WritableFont.ARIAL, WritableFont.DEFAULT_POINT_SIZE, WritableFont.NO_BOLD, false,
        ...
        WritableFont arial10ptSingleAcc =
            new WritableFont( WritableFont.ARIAL, WritableFont.DEFAULT_POINT_SIZE, WritableFont.NO_BOLD, false,
        ...
        WritableFont arial10ptDoubleAcc =
            new WritableFont( WritableFont.ARIAL, WritableFont.DEFAULT_POINT_SIZE, WritableFont.NO_BOLD, false,
        ...
        WritableFont times14ptBoldUnderline =
            new WritableFont( WritableFont.TIMES, 14, WritableFont.BOLD, false, UnderlineStyle.SINGLE );
        ...
        WritableFont arial18ptBoldItalicUnderline =
            new WritableFont( WritableFont.ARIAL, 18, WritableFont.BOLD, true, UnderlineStyle.SINGLE );
        ...
        lr =
            new Label( 0, 24, "A very long label, more than 255 characters\012" + "Rejoice O shores\012"
                + "Sing O bells\012" + "But I with mournful tread\012" + "Walk the deck my captain lies\012"
                + "Fallen cold and dead\012" + "Summer surprised, coming over the Starnbergersee\012"
                + "With a shower of rain. We stopped in the Colonnade\012"
                + "A very long label, more than 255 characters\012" + "Rejoice O shores\012" + "Sing O bells\012"
                + "But I with mournful tread\012" + "Walk the deck my captain lies\012" + "Fallen cold and dead\012"
                ...
                + "Summer surprised, coming over the Starnbergersee\012"
                + "With a shower of rain. We stopped in the Colonnade\012"
                + "And sat and drank coffee an talked for an hour\012", arial12format );
        s1.addCell( lr );
        ...
        try
        {
            ...
            url =
                new URL( "http://www.amazon.co.uk/exec/obidos/ASIN/0571058086"
        ...
        /*
         * l = new Label(5, 16, "merged cells"); s1.addCell(l); Label l5 = new Label(7, 17, "this label won't appear");
         * s1.addCell(l5); s1.mergeCells(5, 16, 8, 18); s1.mergeCells(5, 19, 6, 24); s1.mergeCells(6, 18, 10, 19);
         */
        ...
        cellFeatures.setComment( "a very long cell comment indeed that won't "
            + "fit inside a standard comment box, so a " + "larger comment box is used instead", 5, 6 );
        l.setCellFeatures( cellFeatures );
        s1.addCell( l );
        ...
        throws WriteException
    {
        ...
        f = new Formula( 2, 42, "CHOOSE(2,A1,A2,A3,A4)" );
        ws.addCell( f );
        System.err.println( "Choose" );
        l = new Label( 3, 42, "CHOOSE(2,A1,A2,A3,A4" );
        ws.addCell( l );
        ...
        f =
            new Formula(
                         2,
                         44,
                         "F29+F34+F41+F48+F55+F62+F69+F76+F83+F90+F97+F104+F111+F118+F125+F132+F139+F146+F153+F160+F167+F174+F181+F188+F195+F202+F209+F216+F223+F230+F237+F244+F251+F258+F265+F272+F279+F286+F293+F300+F305+F308" );
        ws.addCell( f );
        l =
            new Label(
                       3,
        ...
        // Errors
        /*
         * f = new Formula(2, 25, "PLOP(15)"); // unknown function ws.addCell(f); f = new Formula(2, 26, "SUM(15,3"); //
         * unmatched parentheses ws.addCell(f); f = new Formula(2, 27, "SUM15,3)"); // missing opening parentheses
         * ws.addCell(f); f = new Formula(2, 28, "ROUND(3.14159)"); // missing args ws.addCell(f); f = new Formula(2,
         * 29, "NONSHEET!A1"); // sheet not found ws.addCell(f);
         */
    }
        ...
        throws WriteException
    {
        ...
        WritableImage wi = new WritableImage( 0, 3, 5, 7, new File( "resources/wealdanddownland.png" ) );
        ws.addImage( wi );

        l = new Label( 0, 12, "Merchant Adventurers Hall, York" );
        ws.addCell( l );

        wi = new WritableImage( 5, 12, 4, 10, new File( "resources/merchantadventurers.png" ) );
        ws.addImage( wi );

        // An unsupported file type
        /*
         * wi = new WritableImage(0, 60, 5, 5, new File("resources/somefile.gif")); ws.addImage(wi);
         */
    }
}
